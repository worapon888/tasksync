...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={clsx(
          "sticky top-[80px] left-[50px] sm:left-[100px] lg:left-[120px] z-40 ml-4 transition-all duration-300 ease-in-out",
          isExpanded
            ? "h-fit min-h-[60vh] max-h-[90vh] w-20 bg-white/80 dark:bg-[#242739]/60 rounded-full py-6 drop-shadow-2xl flex flex-col justify-between items-center overflow-hidden"
      ...
      >
        ...
        {isExpanded && (
          <>
            ...
            {user ? (
              <div className="flex flex-col items-center space-y-10 mb-2">
                {profile.image ? (
                  <Image
