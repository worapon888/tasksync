...
export default function DashboardPage() {
  ...
  return (
    <div className="relative z-10 ml-0 md:ml-24 px-4 py-10 md:px-10 w-full min-h-screen overflow-auto">
      <div className="flex flex-col xl:flex-row xl:items-stretch justify-start gap-12 max-w-[1600px] mx-auto ">
        <div className="mb-5">
          {/* Assistant Selector */}
          <div>
            <select
      ...
      <div className="flex flex-col xl:flex-row xl:items-stretch justify-center gap-12 max-w-[1600px] mx-auto ">
        {/* ฝั่งซ้าย */}
